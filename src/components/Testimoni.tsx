...
function Testimoni() {
  ...
  return (
    <section id="testimoni" className="flex max-w-6xl mx-auto flex-col pb-28">
        ...
        <Slider {...settings}>
            ...
            <div>
                ...
                <div>
                    ...
                    <div className="mt-4">
                    <p className="text-2xl font-bold text-blue-600 sm:text-3xl">Sinta P.</p>

                    <p className="mt-4 leading-relaxed text-gray-700">
                    Saya sangat puas dengan layanan Washtop Laundry Express! Kualitas cucian yang luar biasa dan pelayanan yang sangat ramah. Sangat membantu usaha saya dalam menjaga kualitas produk bersih dan rapi.
                    </p>
                    </div>
                </div>

                <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
                    &mdash; Pengusaha UMKM
                </footer>
                </blockquote>
            </div>
            </div>
            ...
            <div className="keen-slider__slide">
                ...
                <div>
                    ...
                    <div className="mt-4">
                    <p className="text-2xl font-bold text-blue-600 sm:text-3xl">Andi</p>

                    <p className="mt-4 leading-relaxed text-gray-700">
                    Tempat cucian favorit saya sejak pertama kali mencoba! Cepat, efisien, dan hasilnya bersih sempurna. Cocok banget buat mahasiswa yang butuh kepraktisan!
                    </p>
                    </div>
                </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div className="mt-4">
                    <p className="text-2xl font-bold text-blue-600 sm:text-3xl">Rini</p>

                    <p className="mt-4 leading-relaxed text-gray-700">
                    Washtop Laundry Express adalah pilihan tepat untuk keluarga saya. Hasil cucian bersih, waktu pengerjaan yang singkat, dan harga yang terjangkau. Sungguh nyaman dan membantu!
                    </p>
                    </div>
                </div>

                <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
                    &mdash; Ibu Rumah Tangga
                </footer>
                </blockquote>
            </div>
            </div>
            ...
            <div className="keen-slider__slide">
                ...
                <div>
                    ...
                    <div className="mt-4">
                    <p className="text-2xl font-bold text-blue-600 sm:text-3xl">Dewi Cintya</p>

                    <p className="mt-4 leading-relaxed text-gray-700">
                    Baru saja pindah ke Singaraja dan menemukan Washtop Laundry Express. Puas banget dengan kualitas dan layanannya! Saya sudah merasa 'at home' dengan layanan laundry yang nyaman ini.
                    </p>
                    </div>
                </div>

                <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
                    &mdash; Pendatang Baru di Singaraja
                </footer>
                </blockquote>
            </div>
            </div>
            ...
            <div className="keen-slider__slide">
                ...
                <div>
                    ...
                    <div className="mt-4">
                    <p className="text-2xl font-bold text-blue-600 sm:text-3xl">Putra Wiratama</p>

                    <p className="mt-4 leading-relaxed text-gray-700">
                    Sebagai pebisnis online, kebersihan barang dagangan sangat penting. Washtop Laundry Express memberikan solusi yang handal dengan hasil cucian yang selalu memuaskan. Terima kasih atas layanan yang konsisten!
                    </p>
                    </div>
                </div>

                <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
                    &mdash; Pelaku Bisnis Online
                </footer>
                </blockquote>
            </div>
            </div>
