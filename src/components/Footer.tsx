    ...
    <footer className="px-4 divide-y divide-slate-500 bg-slate-700 text-gray-300">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <a href="https://maps.app.goo.gl/hZ3m6FEWfknbRrBi6" target="_blank">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <p className="pl-2">082145555566</p>
              </a>
              <a
                rel="noopener noreferrer"
              ...
              >
                ...
                <p className="pl-2">washtoplaundryexpress</p>
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="py-6 text-[11px] text-center text-gray-400">
        <a href="/" target="_blank" rel="noopener noreferrer">
          ©️ 2023 Washtop Team | All rights reserved
        </a>
      </div>
    </footer>
  );
