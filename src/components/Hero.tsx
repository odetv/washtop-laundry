...
function Hero() {
  ...
  const texts = ["Nyaman.", "Cepat.", "Berkualitas."];
  useEffect(() => {
    const daysID: Days[] = [
      "Senin",
      "Selasa",
    ...
    >
      <div className="w-full h-full">
        ...
        <p className="text-base pb-6 tracking-wide">
          Dapatkan Kualitas laundry terbaik hanya dari Kami. Hadir dengan
                  ...
                  <div id="info-washtop-buka" className="text-tiny">
                    {isServiceOpen ? (
                      <>
                        ...
                        <p>Dari Pukul 08.00 - 21.00 WITA</p>
                      </>
                    ) : (
                      <>
                        <p>Laundry Kami Sudah Tutup!</p>
                        <p>Buka kembali dari Pukul 08.00 - 21.00 WITA</p>
                      </>
                    )}
                  </div>
                </div>
